 ...
 */
function login() {
    return location.href = "http://127.0.0.1:8084/user/showLogin";
}
function regist() {
    return location.href = "http://127.0.0.1:8084/user/showRegister";
}
...
function search(a) {
    var b = "http://127.0.0.1:8083/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
